...
class Admin extends Admin_Controller
{
    ...
    public function dashboard()
    {
        ...
        $parameter = array('opd' => $this->patient_model->getEarning('opd_details.id', 'opd_details', '', '', array('appointment_date >=' => date('Y-m-01'), 'appointment_date <=' => date('Y-m-t'))) + ($this->patient_model->getEarning('paid_amount', 'opd_payment', '', '', $search)) + $this->patient_model->getEarning('net_amount', 'opd_billing', '', '', $search),
            'ipd' => $this->patient_model->getEarning('ipd_details.id', 'payment', '', '', $search) + $this->patient_model->getEarning('net_amount', 'ipd_billing', '', '', $search),
        ...
        foreach ($parameter as $key => $value) {
            $data[$key . "_income"] = $value; //number_format($value, 2);
