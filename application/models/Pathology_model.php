...
class Pathology_model extends CI_Model
{
    ...
    public $columnreport_search = array('pathology_report.bill_no','pathology_report.reporting_date','patients.patient_name','pathology.test_name','pathology.short_name','staff.name','pathology_report.description','pathology_report.status','pathology_report.apply_charge');
    ...
    {
        $this->db->select('pathology_report.*,users.username,users.password,pathology.test_name,pathology.short_name,pathology.report_days,patients.patient_name,staff.name as doctorname,staff.surname as doctorsurname');
    ...
    public function getPathoReports($type, $p_name, $t_date, $r_date,$t_name=null) {
       // echo $t_name;exit;
        ...
        pathology_report.apply_charge, pathology.test_name, pathology.short_name, staff.name, staff.surname,kpo.name as kpo_name')
