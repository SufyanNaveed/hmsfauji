...
class Staff_model extends CI_Model
{
    ...
    public function search_commision($id){
        ...
        // $this->db->select('id,MONTHNAME(appointment_date) as month_name,MONTH(appointment_date) as month,YEAR(appointment_date) as year_name,comission_amount as commision,comission_status')->from('monthly_comission');
        // $this->db->where('staff_id',$id);
