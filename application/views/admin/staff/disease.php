                ...
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php } if ($this->rbac->hasPrivilege('disease', 'can_view')) { ?>
                            <li><a href="<?php echo base_url(); ?>admin/disease" class="active"><?php echo $this->lang->line('disease'); ?></a></li>
                        <?php } ?>
            ...
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('disease'); ?> <?php echo $this->lang->line('list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('disease', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm disease"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('disease'); ?></a>  
                            <?php } ?>   
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('disease'); ?></div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($disease as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> <?php echo $value['disease'] ?></td>
                                           <!--  <td><?php echo $this->lang->line($value['is_active']) ?></td> -->
                                            <td class="mailbox-date pull-right no-print">
                                                <?php if ($this->rbac->hasPrivilege('disease', 'can_edit')) { ?>
                                                ...
                                                <?php } if ($this->rbac->hasPrivilege('disease', 'can_delete')) { ?>
                                                    <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>admin/disease/diseasedelete/<?php echo $value['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')";>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title"> <?php echo $this->lang->line('add'); ?>  <?php echo $this->lang->line('disease'); ?></h4> 
            </div>



            <form id="formadd" action="<?php echo site_url('admin/disease/add') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            ...
                            <input autofocus="" id="type"  name="diseaseid" placeholder="" type="hidden" class="form-control"  value="<?php
                            if (isset($result)) {
                                echo $result["id"];
                            }
                            ?>" />
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"> <?php echo $this->lang->line('edit'); ?>  <?php echo $this->lang->line('disease'); ?></h4> 
            </div>



            <form id="editformadd" action="<?php echo site_url('admin/disease/edit') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            ...
                            <input autofocus="" id="degi_id"  name="diseaseid" placeholder="" type="hidden" class="form-control"  />
                        </div>
...
<script>
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>admin/disease/get_data/' + id,

            success: function (result) {
                $('#degi_id').val(result.id);
                $('#type1').val(result.disease);
            }
