<div class="content-wrapper">
        ...
        <div class="row">
            ...
            if ($this->module_lib->hasActive('OPD')) {
                if ($this->rbac->hasPrivilege('opd_income_widget', 'can_view')) {
                    ?>
                    <div class="col-lg-2 col-md-4 col-sm-6 col25
                         ">
                        <div class="info-box">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/patient/ipdsearch') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('ipd') . " " . $this->lang->line('patient');; ?></span>
                                    <span class="info-box-number"><?php
                                        if (!empty($ipd_income)) {
                                            echo $ipd_income;
                                        } else {
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/pharmacy/bill') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('pharmacy') . " " . $this->lang->line('patient'); ?></span>
                                    <span class="info-box-number"><?php
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/pathology/search') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('pathology') . " " . $this->lang->line('patient'); ?></span>
                                    <span class="info-box-number"><?php
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/radio/search') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('radiology') . " " . $this->lang->line('patient'); ?></span>
                                    <span class="info-box-number"><?php
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/operationtheatre/otsearch') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('operation_theatre') . " " . $this->lang->line('patient'); ?></span>
                                    <span class="info-box-number"><?php
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25">
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/bloodbank/issue') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('blood_bank') . " " . $this->lang->line('patient'); ?></span>
                                    <span class="info-box-number"><?php
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 col25
                        ...
                        <div class="info-box">
                            <a href="<?php echo site_url('admin/vehicle/search') ?>">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text"><?php echo 'Total '.$this->lang->line('ambulance'); ?></span>
                                    <span class="info-box-number"><?php
    ...
    ?>
                <!-- <div class="col-lg-2 col-md-3 col-sm-6 col25">
                    <div class="info-box">
...
<?php } ?>
        ...
        <div class="row">
            ...
            <?php if ($this->rbac->hasPrivilege('staff_role_count_widget', 'can_view')) {
                ?>
                <div class="col-lg-3 col-md-3 col-sm-12 col25">
