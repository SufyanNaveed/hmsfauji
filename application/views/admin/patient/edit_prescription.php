            ...
            <div class="row">
                <div class="col-sm-3">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        <?php echo $this->lang->line('diagnosis'); ?><a data-toggle="modal" onclick="holdModal('add_diagnosis','append_prescription_diagnosis')" class="btn btn-primary btn-sm adddiagnosis"><i class="fa fa-plus"></i></a></label> <small class="req"> *</small>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        <?php echo $this->lang->line('test') ; ?><a data-toggle="modal" onclick="holdModal('add_investigation','append_prescription_lab')" class="btn btn-primary btn-sm addinvestigation "><i class="fa fa-plus"></i></a></label> <small class="req"> *</small>
