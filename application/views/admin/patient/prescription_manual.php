            ...
            <div class="col-md-12">
                ...
                <div class="">
                    ...
                    <table border = 0 width="100%" class="printablea4">
                        ...
                        <tr>
                            <th><br><?php echo $this->lang->line("email"); ?></th>
                            <td><br><?php echo $result["email"] ?></td>
                            <th><br></th>
                            <td><br></td>
                            <th><br><?php echo $this->lang->line('consultant'); ?> <?php echo $this->lang->line(''); ?></th>
                            <td><br><?php echo $result["name"] . " " . $result["surname"] ?></td>
...
<div class="vl"></div> -->
                    ...
                    <table align="right" border = 0 class="printablea4" >
                        <tr> <th padding:15px; style="text-align:right;">Temperature __________________________F <br><br></th></tr>
                        <tr> <th style="text-align:right;">BP______________________________mmHg<br><br> </th></tr>
                        <tr> <th style="text-align:right;">Pulse_____________________________/min <br><br></th></tr>
                        <tr> <th style="text-align:right;">SPO2________________________________%<br><br> </th></tr>
                        <tr> <th style="text-align:right;">Weight______________________________kg <br><br></th></tr>
                        <tr> <th style="text-align:right;">Investigations_________________________ <br><br></th></tr>
                        <tr> <th style="text-align:right;">_________________________ <br><br></th></tr>
                    </table>
                    
                    <hr style="height: 1px; clear: both;margin-bottom: 10px; margin-top: 10px" />
                    <table width="100%" class="printablea4"> <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                        <tr>
