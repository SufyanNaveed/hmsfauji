                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
						 ...
						 <button type="button" onclick="getEditRecord('<?php echo $result['id']?>')" class="btn btn-info pull-right"><?php echo $this->lang->line('edit'); ?></button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <?php } } ?>
                        <li><a href="#investigation" data-toggle="tab" aria-expanded="true"><i class="fa fa-plus-square ftlayer"></i> Lab Investigations</a></li>
                    </ul>
                    <div class="tab-content">
                                            ...
                                            if (!empty($opd_details)) {
                                                foreach ($opd_details as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo isset($value['next_visit']) && !empty($value['next_visit']) ? date('d M Y',strtotime($value['next_visit'])) : 'N/A'; ?></td>
                                                        <td class="text-right" width="70">
                                                            ...
                                                            <?php } ?>
                                                            <a target="_blank" href="<?php echo base_url('admin/payment/printBillInvoice/'. $result["id"] . "/" . $value["id"])?>"  class="btn btn-default btn-xs" data-toggle="tooltip" title="Print Invoice">
                        ...
                        <div class="tab-pane" id="investigation">
                            <div class="impbtnview20">
                                ...
                                if ($this->rbac->hasPrivilege('opd diagnosis', 'can_add')) {
                                    ...
                                    if ($diagnosis == 'yes') {
                                        ...
                                        <a data-toggle="modal" onclick="holdModal('add_investigation')" class="btn btn-primary btn-sm addinvestigation"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') ?> <?php echo $this->lang->line('test'); ?></a>
                                    <?php }
                                }
                                ?>
                            </div>
                            ...
                            <div class="download_label"><?php echo $result['patient_name'] . " " . $this->lang->line('opd') . " " . $this->lang->line('details'); ?></div>
                            <a target="_blank" class="dt-button btn-xs pull-right" data-toggle="tooltip" title="" data-original-title="Print All Lab Reports"href="<?php echo base_url('admin/patient/printLabInvestigations/'.$id) ?>" style="margin-top:1.9px">
                                <i class="fas fa-file-prescription"></i>
                            </a>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover example">
                                    <thead>
                                        ...
                                        <th><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge'); ?></th>
                                        <th class="text-right"><?php echo $this->lang->line('action'); ?></th>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        if (!empty($lab_report)) {
                                            foreach ($lab_report as $reports_key => $reports_value) {
                                              
                                                ?>  
                                                <tr>
                                                    <td><?php echo $reports_value["report_type"] ?></td>
                                                    <td><?php 
                                                    if((($reports_value['report_date'] != '1970-01-01')) ){
                                                       echo date($this->customlib->getSchoolDateFormat(), strtotime($reports_value['report_date']));
                                                    }                                                  
                                                     ?></td>
                                                    <td><?php echo $reports_value["name"] ?> <?php echo $reports_value["surname"] ?></td>
                                                    <td><?php echo $reports_value["description"] ?></td>
                                                    <td><?php echo $reports_value["pathology_report_value"] ?></td>
                                                    <td><?php echo $reports_value["apply_charge"] ?></td>
                                                    <td class="text-right">
                                                        <?php if (!empty($reports_value["document"])) { ?>
                                                            <a href="<?php echo base_url() . "admin/patient/report_download/" . $reports_value["document"] ?>" data-toggle="tooltip" class="btn btn-default btn-xs" data-original-title="<?php echo $this->lang->line('download'); ?>" title="<?php echo $this->lang->line('download_'); ?>" ><i class="fa fa-download"></i></a>
                                                        <?php } ?>
                                                        <?php if ($this->rbac->hasPrivilege('add_patho_patient_test_report', 'can_edit')) { ?>
                                                            <a 
                                                            onclick="addParametervalue('<?php echo $reports_value['id']; ?>', '<?php echo $reports_value['pathology_id']; ?>')" class='btn btn-default btn-xs '  data-toggle='tooltip' title="" data-original-title="<?php echo $this->lang->line('add') .'/'.$this->lang->line('edit').' '.$this->lang->line('parameter').' '.$this->lang->line('value'); ?>" ><i class='fa fa-pencil' aria-hidden='true'></i>
                                                            </a>   
                                                        <?php } ?>
                                                        <?php if ($this->rbac->hasPrivilege('opd diagnosis', 'can_delete')) { ?>
                                                            <a 
                                                                onclick="deleteOpdPatientDiagnosis('<?php echo $reports_value['patient_id']; ?>', '<?php echo $reports_value['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title=""  data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                <i class="fa fa-trash"></i>
                                                            </a>   
                                                        <?php } ?>
                                                    </td>
 ...
 -->
                            ...
                            <div class="col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="edit_next_visit" class="form-control next_visit" value="" name="next_visit" readonly="" autocomplete="off">
                ...
                <div class="modal-body pt0 pb0">
                        ...
                        <div class="col-sm-3">
                            <div class="col-sm-12">
                                <div class="form-group mt-2">
                                    <label>
                                        <?php echo "Problems"; ?><a data-toggle="modal" onclick="holdModal('add_symtoms')" class="btn btn-primary btn-sm adddiagnosis"><i class="fa fa-plus"></i></a></label> <small class="req"> *</small>
                                            <select class="form-control select2" style="width: 100%" name='symptom[]' id="symptom_check" multiple>
                                                <option value=""><?php echo $this->lang->line('select') ?>
                                                </option>
                                                <?php foreach ($problems as $dkey => $problem) {
                                                ?>
                                                <option value="<?php echo $problem["id"]; ?>"><?php echo $problem["symptoms_type"] ?>
                                                </option>   
                                                <?php } ?>
                                            </select>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        ...
                                        <a data-toggle="modal" onclick="holdModal('add_diagnosis','append_prescription_diagnosis')" class="btn btn-primary btn-sm adddiagnosis"><i class="fa fa-plus"></i></a></label> <small class="req"> *</small>
                                            <select class="form-control select2" style="width: 100%" name='diagnosis[]' id="diagnosis_prescription" multiple>
                                                <option value=""><?php echo $this->lang->line('select') ?>
                                                </option>
                                                <?php foreach ($diagnosis_detail as $dkey => $diagnosis_det) {
                                                ?>
                                                <option value="<?php echo $diagnosis_det["id"]; ?>"><?php echo $diagnosis_det["report_type"] ?>
                                                </option>   
                                                <?php } ?>
                                            </select>
                                </div>
                                    ...
                                    <label>
                                        <?php echo $this->lang->line('test') ; ?>
                                            ...
                                            <select class="form-control select2" style="width: 100%" name='lab_test[]' id="lab_test" multiple>
                                                ...
                                                ?>
                                                <option value="<?php echo $lb_report["id"]; ?>"><?php echo $lb_report["report_type"] ?>
                                                </option>   
                                                <?php } ?>
                                            </select>
                                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="note_instruction" rows="3" id="note_instruction"></textarea>
                        </div>
                    </div>
                <div class="col-sm-2">
                     <div class="ptt10">
                                ...
                                foreach ($roles as $role_key => $role_value) {
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="next_visit_prescription" class="form-control next_visit" value="" name="next_visit_prescription"  autocomplete="off">
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="form_diagnosis" accept-charset="utf-8"  enctype="multipart/form-data" method="post" class="">
                <input type="hidden" name="append_prescription_diagnosis" value="" id="append_prescription_diagnosis">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            <div class="col-sm-12">
...
<div class="modal fade" id="add_investigation"  role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title"> <?php echo $this->lang->line('add') . " " . $this->lang->line('report'); ?></h4> 
            </div>
            <form id="formbatch" accept-charset="utf-8"  enctype="multipart/form-data" method="post" class="">
                <input type="hidden" name="pathology_id" id="patho_id" >
                <input type="hidden" name="append_prescription_lab" id="append_prescription_lab" >
                ...
                <input type="hidden" name="patient_name" value="<?php echo $result['patient_name']; ?>">
                <input type="hidden" name="customer_type" value="OPD">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <small class="req"> *</small> 
                                            <div>
                                                <select class="form-control select2" style="width: 100%" name='pathology_category_id' onchange="selectpathcategory(this.value)">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <small class="req"> *</small> 
                                            <div>
                                                <select class="form-control select2" style="width: 100%" name='test_name' id="test_name" onchange="getTestDescp(this.value, 'charge_id')">
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('test') . " " . $this->lang->line('description'); ?></label>
                                            <small class="req"> *</small> 
                                            <input type="text" name="test_type" class="form-control" id="test_descp" readonly>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="charge_category" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('code'); ?></label>
                                            <input type="text" id="charge_code" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge') . ' (' . $currency_symbol . ')'; ?></label>
                                            <input type="text" id="stan_charge" class="form-control" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apply_charge" id="applied_charge" class="form-control" >
                                        </div>
                                    </div>  
                ...
                <div class="box-footer">
                    <div class="pull-right" style="margin-right:10px;">
                        <button type="submit"  data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info pull-right" id="testsavebtn"><?php echo $this->lang->line('save')?></button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div>   
                            <input type="text" class="form-control" name= "p_name" value="<?php echo $result["patient_name"] ?>" readonly="">   
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="hidden" name="patient_id_patho" id="patientid_patho" value="<?php echo $result['id'] ?>">
...
<!-------add symtoms-------------->
<div class="modal fade in" id="add_symtoms" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  aria-hidden="false">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="box-title"> Add  Problems</h4> 
            </div>
            <form id="symtomadd" name="employeeform" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Problems </label><small class="req"> *</small>
                            <input autofocus="" id="symptoms_type" name="symptoms_type" placeholder="" type="text" class="form-control" value="" autocomplete="off">
                            <span class="text-danger"></span>
                        </div>             
                    </div>
                </div><!--./mpdal-->       
                <div class="box-footer">
                    <div class="pull-right" style="margin-right: 10px; ">                            
                        <button type="submit"  data-loading-text="<?php echo $this->lang->line('processing') ?>" value="save_only" class="btn btn-info pull-right add_symptoms" ><?php echo $this->lang->line('save'); ?></button>
                    </div>
                    <div class="pull-right" style="margin-right: 10px; ">    
                        <button type="submit"  data-loading-text="Processing..." class="btn btn-info  add_symptoms pull-right" value="save_another">Save Another</button>
                    </div>
                </div>
            </form>
        </div><!--./row--> 
...
<script type="text/javascript">
    ...
    function edit_prescription(id, opdid) {
        ...
        var visit_id=-1;
        $.ajax({
            url: '<?php echo base_url(); ?>admin/prescription/editPrescription/' + id + '/' + opdid+'/'+visit_id+'/'+patient_id,
    ...
    function editRecord(id, opdid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#edit_next_visit").val(data.next_visit);
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        successMsg(data.message);
                        if(data.append_prescription_diagnosis!=''){
                            var div_data_diag='';
                            ne = 'selected';
                            div_data_diag += "<option value='" + data.append_prescription_diagnosis.id + "' " + ne + " >" + data.append_prescription_diagnosis.append_prescription_diagnosis + "</option>";
                            $('#diagnosis_prescription').append(div_data_diag).trigger('change');
                        }else{
                            window.location.reload(true);
                        }
    ...
    $(document).ready(function (e) {
        $("#form_investigation").on('submit', (function (e) {           
            $("#form_investbtn").button('loading');
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/add_diagnosis',
                type: "POST",
    ...
    function getMedicineInstruction(id)
    {
        var category_selected = $("#medicine_cat" + id).val();
        var arr = category_selected.split('-');
        var category_set = arr[0];
        ...
        $("#search-instruction" + id).html("<option value='l'><?php echo $this->lang->line('loading') ?></option>");
        $('#search-instruction' + id).select2("val", +id);
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                {
                    var sel = "";
                    div_data_ck += "<option value='" + obj.instruction + "'>" + obj.instruction + "</option>";

                });
                $("#search-instruction" + id).html("<option value=''>Select</option>");
                $('#search-instruction' + id).append(div_data_ck);
                //$("#search-dosage" + id).select2();
                $('#search-instruction' + id).select2("val", '');
               // alert(div_data_ck);
...
<script type="text/javascript">
    ...
    function holdModal(modalId,append_value="") {
        $('#' + modalId).modal({
            backdrop: 'static',
            keyboard: false,
            show: true
        });
        if(modalId=='add_diagnosis' && append_value!=''){$('#append_prescription_diagnosis').val(append_value);}
        if(modalId=='add_investigation' && append_value!=''){$('#append_prescription_lab').val(append_value);}
    }
...
$(".addinvestigation").click(function(){	
	$('#form_investigation').trigger("reset");	
	$(".dropify-clear").trigger("click");	
});
...
<script>
    function selectpathcategory(patho_category) {
        var div_data = "";
        $('#test_name').html("<option value='l'><?php echo $this->lang->line('loading') ?></option>");
        $("#test_name").select2("val", "l");
        $.ajax({
            url: '<?php echo base_url(); ?>admin/patient/getTestList',
            type: "POST",
            data: {patho_category: patho_category},
            dataType: 'json',
            success: function (res) {
                $.each(res, function (i, obj) {
                    var sel = "";
                    div_data += "<option value='" + obj.charge_id + "' " + sel + ">" + obj.test_name + "</option>";
                });
                $('#test_name').html("<option value=''>Select</option>");
                $('#test_name').append(div_data);
                $("#test_name").select2().select2('val', test_id);

            }
        });
    }

    function getTestDescp(id) {
       if(id != ""){
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/getTestDetails',
                type: "POST",
                data: {charge_id: id},
                dataType: 'json',
                success: function (res)
                {
                    $.each(res, function (i, obj) {
                        $('#test_descp').val(obj.description);
                        $('#charge_category').val(obj.charge_category);
                        $('#charge_code').val(obj.code);
                        $('#stan_charge').val(obj.standard_charge);
                        $('#applied_charge').val(obj.standard_charge);
                        $('#patho_id').val(obj.patho_id);
                    });
                }
            });
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        successMsg(data.message);
                        if(data.append_prescription_lab!=''){
                            var div_data_lab='';
                            ne = 'selected';
                            div_data_lab += "<option value='" + data.append_prescription_lab.id + "' " + ne + " >" + data.append_prescription_lab.report_type + "</option>";
                            
                            $('#lab_test').append(div_data_lab).trigger('change');
                        }
                        else{
                            window.location.reload(true);
                        }
                    ...
                    $("#testsavebtn").button('reset');
                    if(data.append_prescription_diagnosis!=''){
                        $('#add_investigation').modal('hide');
                    }
    ...
    $(document).ready(function (e) {
        $("#symtomadd").on('submit', (function (e) {
           // Print the value of the button that was clicked
           var check_btn=($(document.activeElement).val());
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/symptoms/addsymadd',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        successMsg(data.message);
                        if(data.append_prescription_symtom!=''){
                            var div_data_lab='';
                            ne = 'selected';
                            div_data_lab += "<option value='" + data.append_prescription_symtom.id + "' " + ne + " >" + data.append_prescription_symtom.problem_name + "</option>";
                            
                            $('#symptom_check').append(div_data_lab).trigger('change');
                        }
                        else{
                            window.location.reload(true);
                        }
                        if(check_btn=='save_only'){
                        $(".add_symptoms").button('reset');
                        if(data.append_prescription_diagnosis!=''){
                            $('#add_symtoms').modal('hide');
                        }
...
<script type="text/javascript">
    function printChecked(patho_arr) {        
        var patho_arr = new Array();
        $("input:checkbox[name=patho_id]:checked").each(function(){
            patho_arr.push($(this).val());
        });
        //alert(patho_arr);
        $.ajax({
            url: '<?php echo base_url() ?>admin/pathology/getCheckedBillDetails/' + patho_arr,
            type: "GET",
            data: {patho_arr: patho_arr},
            success: function (data) {
