                ...
                <div class="row">
                    <form role="form" id="schsetting_form" action="<?php echo site_url('schsettings/ajaxedit') ?>">
                      ...
                      <div class="col-md-12">
                        ...
                        <hr/>
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <label for="IsSmallBusiness"><?php echo "Prescription Footer Note"; ?></label>
                            <textarea class="form-control" name="prescription_footer_note" rows="5" id="comment"></textarea>
                        </div>
                        <div class="clearfix"></div>
    ...
    $('.edit_setting').on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('textarea[name="prescription_footer_note"]').text(result.prescription_footer_note);
                $('#schsetting').modal({
                    show: true,
                    backdrop: 'static',
                    keyboard: false
